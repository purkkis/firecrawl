"""
Async parse functionality for Firecrawl v2 API.
"""
...
from ...utils import handle_response_error, prepare_parse_options, validate_parse_options
...
async def parse(
    ...
    *,
    ...
    try:
        ...
        response = await client.post_multipart("/v2/parse", data, files)
    finally:
        if should_close:
            file_handle.close()
